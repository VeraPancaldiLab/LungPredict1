...
```{r}
Deconvolution_Melanoma <- read.csv("~/LungPredict1/Input/Deconvolution/Deconvolution_Melanoma.csv", row.names=1)
...
write.csv(t(deconv_df), "Deconvolution_after_EARLYSTAGE_clusters.csv")
