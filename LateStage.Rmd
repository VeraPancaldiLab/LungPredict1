...
Heatmap(t(scale(dat)),  clustering_method_columns = "ward.D", top_annotation = ha, width = unit(30, "cm"), height = unit(35, "cm"), column_dend_height = unit(5, "cm"), show_heatmap_legend = F)
dev.off()
