...
saveRDS(res, "Groups_cells_all_LATESTAGE.rds")
saveRDS(groups, "Groups_cells_correlation_LATESTAGE.rds")
saveRDS(groups_similarity, "Groups_cells_similarity_LATESTAGE.rds")
```
...
write.csv(t(deconv_df), "Deconvolution_after_LATESTAGE_clusters.csv")
