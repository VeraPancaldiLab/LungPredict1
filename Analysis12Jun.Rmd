...
```{r}
deconv <- as.matrix(read.delim("~/LungPredict1/all_deconvolutions_Counts_LPVan_TPM.txt", row.names=1))
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Deconvolution_before_EARLYSTAGE.png"), width = 6000, height = 7000, res=250)
Heatmap(t(scale(deconv)), cluster_rows = F, clustering_method_columns = "ward.D2", width = unit(30, "cm"), height = unit(50, "cm"), column_dend_height = unit(10, "cm"), row_dend_width = unit(10, "cm"))
dev.off()

png(paste0(getwd(),"/Figures/Heatmaps/New2/M2_EARLYSTAGE.png"), width = 6000, height = 4000, res=250)
Heatmap(t(scale(cells$M2)), cluster_rows = F, clustering_method_columns = "ward.D2", width = unit(30, "cm"), height = unit(20, "cm"), column_dend_height = unit(10, "cm"), row_dend_width = unit(10, "cm"))
dev.off()

png(paste0(getwd(),"/Figures/Heatmaps/New2/NK_EARLYSTAGE.png"), width = 6000, height = 4000, res=250)
Heatmap(t(scale(cells$NK)), cluster_rows = F, clustering_method_columns = "ward.D2", width = unit(30, "cm"), height = unit(20, "cm"), column_dend_height = unit(10, "cm"), row_dend_width = unit(10, "cm"))
dev.off()

png(paste0(getwd(),"/Figures/Heatmaps/New2/CD8_EARLYSTAGE.png"), width = 6000, height = 4000, res=250)
Heatmap(t(scale(cells$CD8)), cluster_rows = F, clustering_method_columns = "ward.D2", width = unit(30, "cm"), height = unit(20, "cm"), column_dend_height = unit(10, "cm"), row_dend_width = unit(10, "cm"))
dev.off()

png(paste0(getwd(),"/Figures/Heatmaps/New2/MONOCYTES_EARLYSTAGE.png"), width = 6000, height = 4000, res=250)
Heatmap(t(scale(cells$MONOCYTES)), cluster_rows = F, clustering_method_columns = "ward.D2", width = unit(30, "cm"), height = unit(20, "cm"), column_dend_height = unit(10, "cm"), row_dend_width = unit(10, "cm"))
dev.off()
```
...
write.csv(TFs_modules_merge, "TFs_modules_EARLY_STAGE.csv")
```
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Module_trait_relationships_EARLYSTAGE.png"), width = 4000, height = 1500, res=150)
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Dendogram_Subgroups_cells_EARLYSTAGE.png"), width = 2500, height = 2500, res=150)
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Deconvolution_EARLYSTAGE.png"), width = 6000, height = 4500, res=250)
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Deconvolution_EARLYSTAGE_NICHES.png"), width = 6000, height = 4500, res=250)
...
saveRDS(niches, "Cell_groups_EARLYSTAGE.rds")
```
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Patients_clusters_EARLYSTAGE.png"), width = 2500, height = 1500, res=150)
plot(hc1)
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Clusters_Feature_Importance_EARLYSTAGE.png"), width = 2000, height = 1500, res=250)
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Deconvolution_EARLYSTAGE_FS_CLUSTERS.png"), width = 6000, height = 4500, res=250)
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/Deconvolution_EARLYSTAGE_VANDERBILT.png"), width = 6000, height = 4500, res=250)
