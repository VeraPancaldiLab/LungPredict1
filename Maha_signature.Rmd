...
Early stage groups
```{r}
niches = readRDS(paste0(getwd(), "/Figures/Heatmaps/New3/Cell_groups_LATESTAGE.rds"))
...
res = random_forest(deconv_df, clinical.data$Response, 10)

png(paste0(getwd(),"/Figures/Heatmaps/New3/Deconvolution_Maha_FS_CLUSTERS.png"), width = 6000, height = 4500, res=250)
ha <- HeatmapAnnotation(Response = clinical.data$Response, col = list(Response = c("Responders" = "green", "Non responders" = "red")))
