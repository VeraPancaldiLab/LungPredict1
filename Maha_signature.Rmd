...
```{r}
idx = c("Cluster_4", "Cluster_17", "Cluster_16", "Cluster_20", "Cluster_15", "Cluster_9", "Cluster_14", "Cluster_12", "Cluster_13", "Cluster_5")
...
Heatmap(t(scale(deconv_df2)), cluster_rows=F,clustering_method_columns = "ward.D2", width = unit(30, "cm"), height = unit(35, "cm"), column_dend_height = unit(5, "cm"), show_heatmap_legend = F)
dev.off()
```
...
png(paste0(getwd(),"/Figures/Heatmaps/New2/EarlyStage_LateStageClusters_Top10_ONLYLP.png"), width = 6000, height = 4500, res=250)
