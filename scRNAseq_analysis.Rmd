...
```{r}
Idents(seurat_anndata) = seurat_anndata@meta.data$singleR.labels
cells = subset(seurat_anndata, idents = c('NK_cell', 'B_cell', 'DC', 'Endothelial_cells', 'Macrophage', 'Monocyte', 'Neutrophils', 'T_cells', 'Fibroblasts', 'Epithelial_cells'), invert = FALSE)
...
```{r}
NK = subset(seurat_anndata, idents = c(8,2,6), invert = FALSE)
